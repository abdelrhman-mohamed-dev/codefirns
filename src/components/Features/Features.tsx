            ...
            <div className='flex flex-col md:flex-row px-8 md:px-20 pt-[150px] gap-[60px] items-center'>
                ...
                <ScrollReveal direction='right'>
                    ...
                    <div className='mt-[-100px]'>
                        ...
                        <p className='md:w-[413px] text-[#999999] text-[16px] mt-10'>{`في "كوديفرنس"، نفخر بتقديم حلول برمجية متقدمة تلبي احتياجات الشركات والمؤسسات بكفاءة وفعالية. تعرف على بعض ميزات منتجاتنا`}</p>
                    </div>
                </ScrollReveal>
