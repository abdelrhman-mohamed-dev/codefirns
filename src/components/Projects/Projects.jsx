            ...
            <div className='md:px-20 px-8'>
                <div className='relative flex flex-col md:flex-row md:items-center justify-between'>
                    ...
                    <ScrollReveal direction='left'>
                        ...
                        <p className='md:w-[413px] text-[#999999] text-[16px] mt-14'>{`في "أي شيفت"، نفخر بتقديم حلول برمجية متقدمة تلبي احتياجات الشركات والمؤسسات بكفاءة وفعالية. تعرف على بعض ميزات منتجاتنا`}</p>
                    </ScrollReveal>
                </div>
                <ScrollReveal>
