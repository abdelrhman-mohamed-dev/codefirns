        ...
        <div className="mt-36 px-8 md:px-20 overflow-hidden">
            <ScrollReveal direction="right">
                ...
                <div>
                    ...
                    <p className="text-[16px] md:text-[18px] text-[#999999] font-[400]" >{"في أي شيفت، نحن ملتزمون بقيم راسخة تُشكل أساس كل ما نقوم به. هذه القيم ليست مجرد كلمات، بل هي المبادئ التي تقودنا وتساعدنا على تقديم أفضل ما لدينا لعملائنا وشركائنا:"}</p>
                </div>
            </ScrollReveal>
